...
function flux_terashima(u_ll, u_rr, orientation::Int, equations::MyEuler1D)
    ...
    rho_e_avg = 0.5 * (rho_e_rhoP(rho_ll, p_ll, equations) + rho_e_rhoP(rho_rr, p_rr, equations))
    ...
    rho_e_v1_avg = (rho_e_avg - 0.25 * (drho_e_drho_p_rr - drho_e_drho_p_ll) * (rho_rr - rho_ll)) * v1_avg
